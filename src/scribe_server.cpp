...
scribe::thrift::ResultCode scribeHandler::Log(const std::vector<scribe::thrift::LogEntry>& messages) {
...
/*  
 * Not have in original (faceboook branch)
 * Using for log and forget, independent scribe server ~ not block client
 */
void scribeHandler::LogAndForget(const std::vector<LogEntry> &messages) {
